...
export const PRESETS: Record<PresetId, Preset> = {
	"openrouter":        { id: "openrouter",        label: "OpenRouter",        defaultBaseUrl: "https://openrouter.ai/api/v1",        suggestedModels: ["google/gemma-4-26b-a4b-it", "google/gemma-4-31b-it:free"], supportsOAuth: true,  supportsApiKey: true },
	"groq":              { id: "groq",              label: "Groq",              defaultBaseUrl: "https://api.groq.com/openai/v1",     suggestedModels: ["gemma2-9b-it"],                                  supportsOAuth: false, supportsApiKey: true },
	...
	"cloudflare-ai":     { id: "cloudflare-ai",     label: "Cloudflare Workers AI", defaultBaseUrl: "cloudflare-ai:",                 suggestedModels: ["@cf/google/gemma-4-26b-a4b-it"],                       supportsOAuth: false, supportsApiKey: false },
